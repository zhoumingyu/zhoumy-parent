 ...
 * 
 */
public class SelectPagerListMethodGenerator extends AbstractJavaMapperMethodGenerator {

	public SelectPagerListMethodGenerator() {
		super();
	}
	...
	public void addInterfaceElements(Interface interfaze) {
		...
		// 导入需要类
		FullyQualifiedJavaType type = new FullyQualifiedJavaType("com.cpp.core.common.utils.Pager");
		...
		method.setName("findPageByCondition");
