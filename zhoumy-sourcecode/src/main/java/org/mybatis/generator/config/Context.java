...
public class Context extends PropertyHolder {
	...
	private JavaJspGeneratorConfiguration javaJspGeneratorConfiguration;
	...
	public JavaJspGeneratorConfiguration getJavaJspGeneratorConfiguration() {
		return javaJspGeneratorConfiguration;
	}
	...
	public void setJavaVoModelGeneratorConfiguration(
			JavaVoModelGeneratorConfiguration javaVoModelGeneratorConfiguration) {
	...
	public void setJavaJspGeneratorConfiguration(JavaJspGeneratorConfiguration javaJspGeneratorConfiguration) {
		this.javaJspGeneratorConfiguration = javaJspGeneratorConfiguration;
	}
	 ...
	 */
	public void generateFiles(ProgressCallback callback, List<GeneratedJspFile> generatedJspFiles,
			List<GeneratedJavaFile> generatedJavaFiles, List<GeneratedXmlFile> generatedXmlFiles, List<String> warnings)
			throws InterruptedException {
		...
		if (introspectedTables != null) {
			for (IntrospectedTable introspectedTable : introspectedTables) {
				...
				generatedJspFiles.addAll(introspectedTable.getGeneratedJspFiles());
				generatedJavaFiles.addAll(pluginAggregator.contextGenerateAdditionalJavaFiles(introspectedTable));
				generatedXmlFiles.addAll(pluginAggregator.contextGenerateAdditionalXmlFiles(introspectedTable));
				generatedJspFiles.addAll(pluginAggregator.contextGenerateAdditionalJspFiles(introspectedTable));
			}
		}

		generatedJavaFiles.addAll(pluginAggregator.contextGenerateAdditionalJavaFiles());
		generatedXmlFiles.addAll(pluginAggregator.contextGenerateAdditionalXmlFiles());
		generatedJspFiles.addAll(pluginAggregator.contextGenerateAdditionalJspFiles());
