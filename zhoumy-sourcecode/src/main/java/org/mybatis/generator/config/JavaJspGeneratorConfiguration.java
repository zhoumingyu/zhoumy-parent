 ...
 * @author Jeff Butler
 */
public class JavaJspGeneratorConfiguration extends TypedPropertyHolder {
	private String targetProject;

	/**
	 *  
	 */
	public JavaJspGeneratorConfiguration() {
		super();
	}
	...
	public XmlElement toXmlElement() {
		XmlElement answer = new XmlElement("javaJspGenerator"); //$NON-NLS-1$
