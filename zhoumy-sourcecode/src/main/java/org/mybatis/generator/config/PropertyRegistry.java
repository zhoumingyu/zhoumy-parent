...
public class PropertyRegistry {
    ...
    public static final String SERVICE_ROOT_INTERFACE = "serviceInterface"; //$NON-NLS-1$
    public static final String SERVICE_ROOT_INTERFACE_IMPL = "serviceInterfaceImpl"; //$NON-NLS-1$
