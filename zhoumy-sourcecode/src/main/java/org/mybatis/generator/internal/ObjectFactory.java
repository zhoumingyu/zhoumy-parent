...
public class ObjectFactory {
	...
	/**
	 * Clears the class loaders. This method should be called at the beginning
	 * of a generation run so that and change to the classloading configuration
	 * will be reflected. For example, if the eclipse launcher changes
	 * configuration it might not be updated if eclipse hasn't been restarted.
	 * 
	 */
