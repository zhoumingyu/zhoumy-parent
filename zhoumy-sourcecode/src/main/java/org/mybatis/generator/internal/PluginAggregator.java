...
public final class PluginAggregator implements Plugin {
	...
	public List<GeneratedJspFile> contextGenerateAdditionalJspFiles(IntrospectedTable introspectedTable) {
		List<GeneratedJspFile> answer = new ArrayList<GeneratedJspFile>();
		for (Plugin plugin : plugins) {
			List<GeneratedJspFile> temp = plugin.contextGenerateAdditionalJspFiles(introspectedTable);
			if (temp != null) {
				answer.addAll(temp);
			}
		}
	...
	public List<GeneratedJspFile> contextGenerateAdditionalJspFiles() {
		List<GeneratedJspFile> answer = new ArrayList<GeneratedJspFile>();
		for (Plugin plugin : plugins) {
			List<GeneratedJspFile> temp = plugin.contextGenerateAdditionalJspFiles();
			if (temp != null) {
				answer.addAll(temp);
			}
		}
